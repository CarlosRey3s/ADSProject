        ...
        public ActionResult<string> ActualizarMateria(int idMateria, [FromBody] Materia materia)
        {
            try
            {
                ...
                else
                {
                    ...
                    return Ok(500, new { pCodRespuesta, pMensajeusuario, pMensajeTecnico });
            ...
            catch (Exception ex)
            {
                ...
                return Ok(500, new { pCodRespuesta = "COD_ERROR", pMensajeusuario = "Error interno del servidor", pMensajeTecnico = ex.Message });
            }
        }

        private ActionResult<string> Ok(int v, object value)
        {
